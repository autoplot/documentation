# org.das2.qds.BDataSetrank 0,1,2,3 or 4 dataset backed by byte array (1 byte signed numbers).
...
# createRank1
createRank1( int len0 ) &rarr; BDataSet
...
# createRank2
createRank2( int len0, int len1 ) &rarr; BDataSet
...
# createRank3
createRank3( int len0, int len1, int len2 ) &rarr; BDataSet
...
# createRank4
createRank4( int len0, int len1, int len2, int len3 ) &rarr; BDataSet
...
<a name="wrap"></a>
# wrap
wrap( byte[] data, int[] qube ) &rarr; BDataSet
...
wrap( byte[] back, int rank, int len0, int len1, int len2 ) &rarr; BDataSet<br>
wrap( byte[] back ) &rarr; BDataSet<br>
wrap( byte[] back, int nx, int ny ) &rarr; BDataSet<br>
wrap( byte[] back, int nx, int ny, int nz ) &rarr; BDataSet<br>

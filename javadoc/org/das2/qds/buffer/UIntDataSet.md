# org.das2.qds.buffer.UIntDataSetUnsigned Integer.
UIntDataSet( int rank, int reclen, int recoffs, int len0, int len1, int len2, int len3, java.nio.ByteBuffer back )

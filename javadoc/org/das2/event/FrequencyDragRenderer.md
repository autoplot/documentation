# org.das2.event.FrequencyDragRenderer



# FrequencyDragRenderer( org.das2.graph.DasCanvasComponent parent, org.das2.graph.DasAxis axis )
Creates a new instance of HorizontalFrequencyDragRenderer

***
<a name="addPropertyChangeListener"></a>
# addPropertyChangeListener
addPropertyChangeListener( String p, java.beans.PropertyChangeListener l ) &rarr; void



### Parameters:
p - a String
<br>l - a PropertyChangeListener
...
removePropertyChangeListener( String p, java.beans.PropertyChangeListener l ) &rarr; void

...
<a name="newCopy"></a>
# newCopy
newCopy( org.das2.dataset.TableDataSet tds ) &rarr; WritableTableDataSet
...
<a href="https://github.com/autoplot/dev/search?q=newCopy&unscoped_q=newCopy">[search for examples]</a>

***
<a name="newEmpty"></a>
# newEmpty
newEmpty( org.das2.dataset.TableDataSet tds ) &rarr; WritableTableDataSet
...
<a href="https://github.com/autoplot/dev/search?q=newEmpty&unscoped_q=newEmpty">[search for examples]</a>

***
<a name="newSimple"></a>
# newSimple
newSimple( int nx, Units xunits, int ny, Units yunits, Units zunits ) &rarr; WritableTableDataSet
...
<a href="https://github.com/autoplot/dev/search?q=newSimple&unscoped_q=newSimple">[search for examples]</a>

***
<a name="setDatum"></a>
# setDatum
setDatum( int i, int j, Datum datum ) &rarr; void
...
<a name="setDouble"></a>
# setDouble
setDouble( int i, int j, double zvalue, Units units ) &rarr; void
...
<a href="https://github.com/autoplot/dev/search?q=setDouble&unscoped_q=setDouble">[search for examples]</a>
...
***
<a name="setXTagDouble"></a>
# setXTagDouble
setXTagDouble( int i, double xvalue, Units units ) &rarr; void
...
<a href="https://github.com/autoplot/dev/search?q=setXTagDouble&unscoped_q=setXTagDouble">[search for examples]</a>
